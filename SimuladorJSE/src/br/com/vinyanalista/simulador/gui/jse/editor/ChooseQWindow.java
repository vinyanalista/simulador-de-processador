...
public class ChooseQWindow extends QMainWindow {
	...
	private void initTable() {
		...
		samplers.add(Example.NEGATIVE.toString());
		samplers.add(Example.OR.toString());
		samplers.add(Example.AND.toString());
		samplers.add(Example.NOT.toString());
		samplers.add(Example.CRASH.toString());
	...
	private void initToolBar() {
		...
		QAction playAction = new MyAction(new QIcon("icons/arrow_right.png"),
				"Inicia a simulação", this, this, "play()");// TODO
	...
	private void getChoose() {
		...
		if (list.size() == 0) {
			...
			case 1:
				...
				break;
			case 2:
				p = Examples.getExample(Example.NEGATIVE);
				break;
			case 3:
				p = Examples.getExample(Example.OR);
				break;
			case 4:
			...
			case 5:
				...
				break;
			case 6:
				p = Examples.getExample(Example.CRASH);
				break;
			default:
				break;
			}
