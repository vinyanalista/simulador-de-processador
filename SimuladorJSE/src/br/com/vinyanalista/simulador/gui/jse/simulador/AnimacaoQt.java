...
public class AnimacaoQt extends QMainWindow {
	...
	public void povoatabela(){
		...
		List<Instruction> inst = new ProgramParser().parseFrom("").getInstructions();
		...
		for(int i=0; i<inst.size(); i++){
			for(int j=0; j<2; j++){
				if(j==0){
					...
					wigitem = new QTableWidgetItem(inst.get(i).getOperator().getValueAsBinary());
					tablePrincipal.setItem(i, j, wigitem);
				}
			}
		}
...
18	ALU_TO_ACC;
	...
	private void CHANGE_IR_OPERAND() {
		//http://lists.trolltech.com/qt-interest/2002-09/thread00617-0.html
				if (byteDeExemplo==null){
				byteDeExemplo = new QLabel(VALOR_FINAL, this);
				byteDeExemplo.setFont(fonte);
	...
	private void CHANGE_ALU_OUTPUT() {
		//http://lists.trolltech.com/qt-interest/2002-09/thread00617-0.html
				if (byteDeExemplo==null){
				byteDeExemplo = new QLabel(VALOR_FINAL, this);
				byteDeExemplo.setFont(fonte);
...
//
//		// http://doc.qt.digia.com/4.6/animation-overview.html#animating-qt-properties
//		QPropertyAnimation moverValorDaMemoriaParaAcc = new QPropertyAnimation(
//				byteDeExemplo, new QByteArray("geometry"));
//		moverValorDaMemoriaParaAcc.setDuration(DURACAO_DA_ANIMACAO);
//
//		moverValorDaMemoriaParaAcc.setKeyValueAt(0, new QRect(612, 320,
//				byteDeExemplo.width(), byteDeExemplo.height()));
//		moverValorDaMemoriaParaAcc.setKeyValueAt(0.2, new QRect(612, 270,
//				byteDeExemplo.width(), byteDeExemplo.height()));
//		moverValorDaMemoriaParaAcc.setKeyValueAt(0.8, new QRect(270, 270,
//				byteDeExemplo.width(), byteDeExemplo.height()));
//		moverValorDaMemoriaParaAcc.setKeyValueAt(0.99, new QRect(270, 210,
//				byteDeExemplo.width(), byteDeExemplo.height()));
//		moverValorDaMemoriaParaAcc.setKeyValueAt(1, new QRect(2000, 2000,
//				byteDeExemplo.width(), byteDeExemplo.height()));
//
//		moverValorDaMemoriaParaAcc.start();
//
//		moverValorDaMemoriaParaAcc.finished.connect(this, "mudarValorDoAcc()");
//	}
//	
//	
//	private void Memory_to_MAR() {
//		byteDeExemplo = new QLabel(VALOR_FINAL, this);
//		byteDeExemplo.setFont(fonte);
//		byteDeExemplo.setPalette(corVerde);
//		byteDeExemplo.setGeometry(740, 320, byteDeExemplo.width(),
...
//		moverValorDaMemoriaParaMAR.setDuration(DURACAO_DA_ANIMACAO);
//
//		moverValorDaMemoriaParaMAR.setKeyValueAt(0, new QRect(612, 320,
//				byteDeExemplo.width(), byteDeExemplo.height()));
//		moverValorDaMemoriaParaMAR.setKeyValueAt(0.2, new QRect(612, 270,
//				byteDeExemplo.width(), byteDeExemplo.height()));
//		moverValorDaMemoriaParaMAR.setKeyValueAt(0.8, new QRect(270, 270,
//				byteDeExemplo.width(), byteDeExemplo.height()));
//		moverValorDaMemoriaParaMAR.setKeyValueAt(0.99, new QRect(270, 330,
//				byteDeExemplo.width(), byteDeExemplo.height()));
//		moverValorDaMemoriaParaMAR.setKeyValueAt(1, new QRect(2000, 2000,
//				byteDeExemplo.width(), byteDeExemplo.height()));
//
